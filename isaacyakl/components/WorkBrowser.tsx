...
export default function WorkBrowser({ workMetadata = [], tagQuery = "", onQueryUpdate = undefined, focus: boolean = undefined }: { workMetadata: Array<WorkFile>; tagQuery: string; onQueryUpdate: Function | undefined; focus: boolean | undefined }) {
